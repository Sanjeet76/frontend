...
const Tearms = () => {
    ...
    return (
        <div className="w-full ">
            ...
            <div className=' w-full float-start flex flex-col justify-center items-center mt-10 '>
                <h2 className="text-center font-bold text-xl text-white p-5 ">Terms</h2>
                <button className=' px-10 text-white bg-[#089e1e] py-3 rounded-full text-lg font-[600]'>Close and Go Back</button>
                <div className='w-3/5 mt-5'>
                    <form className=' bg-white  rounded-lg text-center justify-center '>
                        <div><p className='text-justify  p-6'>VED Å klikke på Fakturere Nå så velger dere å laste ned ifølge den informasjon som dere har lagt inn og teksten på last ned siden og vilkårene her, og aksepterer samtidig vilkårene her.
                            ...
                            Prisen for LettFaktura (tilbudspris kr 99,- per måned / ord. pris kr 129,- per måned) er for årsavgift Start for ett års bruk av programmet.
